...
@section('content')
    ...
    <div class="jumbotron container" style="height:320px">
        <div class="container" >
            ...
            <a class="btn btn-danger btn-lg" href="{{ route('admin.user.trash' , $profile->user_id)}}" role="button">{{$profile->user->name}}'s trash <i class="fa-solid fa-trash"></i></a>
                        ...
                        @foreach ($posts as $post)
                            <div class="col-3 4 mb-4">
                                <div class="card bg-light h-100">
                                    <img src="{{ URL::asset($post->photo) }}" class="card-img-top" width="200px" height="200px">
                                    <div class="card-body">
                                    ...
                                    <a href="{{route('admin.post.show' , $post->slug)}}" title="read more" class="btn btn-round btn-sm btn-secondary">Read More <i class="fa-solid fa-eye"></i></a>
                                </div>
                            </div>
                        @endforeach
                    </div>
