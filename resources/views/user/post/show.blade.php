...
<div class="container" style="padding-top: 1%; padding-left: 5%" >
    ...
    <div class="">
            ...
            <div class="mb-2  rounded alert-secondary" style="padding-top: 2%">
                <ul style="display:inline-flex; list-style-type: none">
                    ...
                    <li style="width: auto"><a  class="btn btn-sm btn-outline-dark m-2 " href="{{ route('user.profile.show', $post->user_id)}}" ><h5> {{ $post->user->name }}</h5></a></li>
                </ul>
            </div>
            ...
            <div class="mb-2  rounded alert-secondary" style="padding-top: 2%">
                <ul style="display:inline-flex; list-style-type: none">
                    ...
                    <li style="width: auto"> <textarea class="btn btn-sm btn-outline-dark m-2" cols="90" rows="auto" style="font-weight: bold;font-size: 20px;"> {{ $post->content }}</textarea> </li>
                </ul>
            </div>
    ...
    <div class="card-body" style="float: left;padding-bottom: 5%">
        @if ($post->user_id == Auth::id() )
            <a class="btn btn-success btn-lg" href="{{ route('user.post.edit', $post->id)}}"> update <i class="fa-solid fa-pen-to-square"></i> </a>
            <a class="btn btn-warning btn-lg" href="{{ route('user.post.soft.delete',$post->id)}}"> soft delete <i class="fa-solid fa-trash"></i></a>
        @endif
